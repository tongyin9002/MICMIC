...
MICMIC_plotting<-function(gene_name,met_data_matrix,exp_data_matrix,control_id=NA,distance=NA,ref_gene_bed,ref_CpGs_bed,sample_class,outfiledir=NA,network="direct")
{
...
plot_network_track<-function(gene_names,CpGs_names,MI_net,CMI_net,gene_name,target_gene_chr,target_gene_TSS,target_gene_length,target_gene_strand,range,ref_gene_bed,ref_CpGs_bed,outfiledir,CpGs_type,network="direct")
{
    plot_range<-genome_coord_to_plot_coord(c(range[1],range[2]),target_gene_chr,target_gene_TSS,target_gene_length,target_gene_strand,range)
